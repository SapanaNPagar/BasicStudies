...
public class Tagging_SD {
	...
	public void user_update_name_with_name(String username) throws IOException, JSONException {

		// Read data from file
		data = new String(Files.readAllBytes(Paths.get("src/test/resources/com/sap/json/myRequest.json")));
	...
	public void user_hit_the_post_request_with_json_data(String job) throws IOException, JSONException {
